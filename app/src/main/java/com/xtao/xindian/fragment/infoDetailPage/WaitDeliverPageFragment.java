...
public class WaitDeliverPageFragment extends Fragment {

    //ll_wait_deliver
    private LinearLayout llWaitDeliver;

    private TextView tvWaitNon;
    // lv_wait_deliver
    private ListView lvWaitDeliver;
    ...
    public WaitDeliverPageFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_wait_deliver_page, container, false);
        llWaitDeliver = view.findViewById(R.id.ll_wait_deliver);
        tvWaitNon = view.findViewById(R.id.tv_wait_non);
        lvWaitDeliver = view.findViewById(R.id.lv_wait_deliver);
        initView();
