...
public class FoodNcvAddTask extends AsyncTask<TbOrderFood, Integer, String> {

    private final String ADD_BUY_CAR_ITEM_NUM = HttpURL.IP_ADDRESS + "/order/foodNumAdd.json";

    @Override
    protected String doInBackground(TbOrderFood... tbOrderFoods) {
        try {
            URL url = new URL(ADD_BUY_CAR_ITEM_NUM);
